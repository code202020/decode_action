//Sun Aug 03 2025 07:49:37 GMT+0000 (Coordinated Universal Time)
...
(e => {
  (() => {
    ...
    const o = ["chrome"],
      r = "vault" in e;
    if (r && undefined === e.vault) throw "Invalid vault";
    const s = e.vault = e.vault || (e => {
      ...
      Dt = (e, t) => Zt(e, t) ? e[t] : undefined,
      At = (e, t) => {
        const n = St(e, t);
        return n ? kt(n).value : undefined;
      },
      Ut = (e, t) => {
        const n = (e, t, o) => {
          const r = St(e, t),
            s = r ? kt(r) : undefined;
          let i;
          return s ? s.enumerable ? s.value : undefined : --o >= 0 && (i = Rt(e)) ? n(i, t, o) : undefined;
        };
        return n(e, t, 5);
      },
      $t = e => {
        const t = (t, ...n) => Pt(e, t, n);
        return Tt(t, "wrappedJSObject", e), t;
      },
      jt = () => e => $t(e),
      Vt = $t(c),
      Ft = e => {
        const t = (e, n) => {
          let o;
          if (null === e) o = "null";else {
            const r = typeof e;
            if ("object" === r) {
              if (n) {
                if (-1 != Yt(n, e)) throw "Converting circular structure to JSON";
                Tt(n, n.length, e);
              } else n = [e];
              if (It(e)) {
                let r = "";
      ...
      Nt = e => {
        const t = I(e),
          n = e => {
            const t = [];
            for (let n = 0; n < e.length; n++) Tt(t, n, o(e[n]));
            return t;
          },
          o = e => {
            if (null === e) ;else if ("object" == typeof e) {
              if (It(e)) return n(e);
              {
                ...
                return Qt(bt(e), r => {
                  const s = e[r];
                  let i;
                  i = "object" == typeof s ? It(s) ? n(s) : o(s) : s, Tt(t, r, i);
                }), t;
              }
            }
            return e;
      ...
      Wt = (e, t, n) => {
        ...
        if (r >= o) return [];
        r < 0 && (r = xt(0, o + r));
        let s = undefined === n ? o : n;
        s < 0 && (s = xt(0, o + s)), s > o && (s = o);
        const i = kt({});
        for (let t = r; t < s; t++) i[t] = At(e, t);
        return Mt(i);
      },
      Kt = jt()(f),
      Jt = (e, ...t) => {
        ...
        for (let e = 0; e < t.length; e++) {
          const r = t[e],
            s = It(r) ? r : [r];
          for (let e = 0; e < s.length; e++) o[n + e] = At(s, e);
          n += s.length;
        }
        return Mt(o);
      },
      ...
      Zn = (() => {
        ...
        return Qt(bt(e), n => {
          try {
            ...
            t[n] = ((e, t) => {
              if (to.error(`Tampermonkey sandbox preparation ${t ? "(" + t + ") " : ""}failed. This usually is caused by a third-party extension.`, e), t) return () => {};
            })(e, `document.${n}`);
          }
        }), t;
      })(),
    ...
    Qt(bt(eo), async e => {
      ...
      if (!no[e]) try {
        let t = At(vt, e);
        if (undefined === t && (mt === vt || undefined === (t = At(mt, e)))) return;
        const n = Qn[e];
        no[e] = false === n && "function" == typeof t ? Vt(t, mt) : t;
      } catch (e) {}
    });
    const oo = e => {
        let t,
      ...
      ro = ({
        ...
        if (undefined === o || undefined === r) throw "invalid args";
        let s,
          i,
          a = 1;
        const l = kt({}),
        ...
        r((n, r) => n == `${t}_${s}` ? (t => {
          ...
          if (l[n] && (Qt(l[n], e => e(a)), delete l[n]), "message.response" == n) {
            if (null == r) throw "Invalid Message";
            ((e, t) => {
              let n;
        ...
        const g = kt({
          ...
          send: (t, n, r, i) => oo(a => {
            let l, c;
            "function" != typeof r && null !== r ? (l = r, c = i) : c = r, o(`${e}_${s}`, kt({
              m: t,
              a: n,
              r: c ? d(c) : null,
              n: l
      ...
      so = ({
        ...
        let d = false,
          g = [];
        const p = () => {
          b = vt.document.documentElement, d = false;
          const e = g;
          g = [], Qt(e, e => {
            d || y() ? zt(g, e) : e();
          });
        ...
        const v = e => {
          ...
          m = (e, t) => {
            ...
            a && Pt(qe, vt, [a]), Pt(qe, vt, [l]);
          },
          _ = t => {
            const n = (e => {
              if ("MouseEvent" === sn(e)) {
                const t = Tn(e);
                if (!t) throw "Invalid MouseEvent";
                return void (f = t);
              }
              const t = rn(Dn(e));
              return f && (t.n = f, f = undefined), t;
            })(t);
            if (!n) return;
            const {
              m: o,
            ...
            if (i[o] && (Qt(i[o], e => e(s)), delete i[o]), "unlock" == o) m(`${e}_${l}`, kt({
              m: "unlocked",
              a: undefined,
              r: null
            })), p();else if ("unlocked" == o) p();else if ("message.response" == o) {
              if (null == r) throw "Invalid Message";
              ((e, t) => {
                let n;
          ...
          h = e => {
            e && (l = e), l && no.addEventListener(`${t}_${l}`, _, true);
          };
        let b, M;
        const y = () => {
            if ((() => {
              ...
              if (M) {
                const e = M;
                M = undefined, e(vt.document);
              }
              return true;
            }
          },
          w = e => (b = vt.document.documentElement, oo(function () {
            var t = n(function* (t) {
              if (M = t, r && !e && (yield null, y())) return;
              const n = new Jn(() => {
                y() && n.disconnect();
              });
          ...
          E = kt({
            ...
            send: (t, n, o, r) => oo(s => {
              let i, a;
              "function" != typeof o && null !== o ? (i = o, a = r) : a = o, y();
              const c = () => {
                m(`${e}_${l}`, kt({
                  m: t,
                  a: n,
            ...
            cleanup: () => {
              l && (no.removeEventListener(`${t}_${l}`, _, true), l = undefined);
            }
          });
        var G;
        return E;
            ...
            return o[n] = kt({
              message: e => {
                if (s && (e => "ack" in e)(e)) {
                  ...
                  (e => {
                    if (!e) return void t.warn("PortMessaging: no message id in ack message");
                    if (a && a.messageId === e) return;
                    let n = -1;
                    qt(l, (t, o) => t.messageId === e && (n = o, true)), -1 !== n ? (Qt(Wt(l, 0, n), e => t.warn(`PortMessaging: message ${e.messageId} was not ack'ed!`, e)), l = Wt(l, n + 1)) : t.warn(`PortMessaging: no one is waiting for ${e}`);
                  })(n);
                }
                c && Qt(c, t => t(e));
              },
              disconnect: () => {
                if (a && r) return i(r, n), v(a), s && Qt(l, e => p(e)), void (d.length && Qt(d, e => e()));
                u.length && Qt(u, e => e()), g();
              }
            }), y;
          },
        ...
        return kt({
          message: (e, n) => {
            ...
            if (e.connect) {
              ...
              if (!(i = o[e.response_id])) return void t.warn("ports: unknown id", e.response_id, e);
              e.disconnect ? i.disconnect() : i.message(e.value);
            }
          },
          connect: function (e, t, o) {
            const r = io();
            return i(e, r), s(n.first, r, t ? e : undefined, o);
          },
          onConnect: kt({
            addListener: e => {
              r = e;
    ...
    const ho = ["GM.backgroundControl"],
      ...
      Ao = kt({
        encode: e => {
          let t = "";
          for (let n = 0; n < e.length; n++) t += hn(255 & wn(e, n));
          return Fe(t);
        },
        decode: e => Ve(e)
      }),
      ...
      $o = (e, t) => oo(n => {
        ...
        o.onload = () => {
          ...
          to.warn(`unable to decode data ${e}`), n("");
        }, t ? fn(o, e, t) : pn(o, e);
      }),
      {
        bridges: jo
    ...
    const No = kt({}),
      ...
      Xo = function (e, t, n, o) {
        const r = () => {
          No[n] && (Pt(e, this, o), delete No[n]);
        };
        "function" == typeof e && (No[n] = e, 0 === t ? ao(() => r()) : jo.first.send("setTimeout", kt({
          t: t || 1
        }), () => r()));
      },
      Bo = function (e, t, n, o) {
        if ("function" == typeof e) {
          ...
          r.onMessage.addListener(() => {
            qo[n] && Pt(e, this, o);
          }), r.onDisconnect.addListener(() => Ho(n)), r.postMessage(kt({
            method: "setInterval",
            t: t || 1
          }));
        }
      ...
      zo = (e, t, ...n) => {
        const o = ++Fo;
        return t = xt(t, 1), Xo(e, t, o, n), o;
      },
      Yo = (e, t, ...n) => {
        const o = ++Vo;
        return t = xt(t, 1), Bo(e, t, o, n), o;
      };
    let Qo;
    const Zo = e => {
        if (undefined === Qo) {
          ...
          const t = "keepAlive",
            n = co.connect(t, true),
            o = no.location.href;
          n.onMessage.addListener(() => {}), n.connectMessage(kt({
            messageId: io(),
            method: t,
            id: e,
            url: o
      ...
      er = t => {
        const {
          ...
          l = (e, t) => function (...n) {
            const o = [];
            if (undefined !== t) for (let e = 0; e < t; e++) zt(o, Yn(n, e) || undefined);
            return new un(t => {
              Pt(e, this, Jt(o, [t]));
            });
          },
          c = (e, t) => {
            ...
            const o = new un((o, r) => {
              ...
              Qt(bt(t), e => {
                ...
                l ? (o(e), Pt(l, this, arguments)) : r(e);
              }, s.ontimeout = function (e) {
                a ? (o(e), Pt(a, this, arguments)) : r(e);
              }, s.onload = function (e) {
                o(e), i && Pt(i, this, arguments);
              };
              const c = e(s).abort;
              true === n ? c() : n = c;
            });
          ...
          of: e => {
            const u = e.script,
              ...
              g = (() => {
                ...
                l && (Zo(o), s = co.connect("values", true, true), s.onDisconnect.addListener(() => {
                  to.warn("values: port disconnected"), s = null;
                  ...
                  o && zt(s, o), Qt(s, e => {
                    const t = n.data[e],
                      o = r[e];
                    undefined === o ? delete n.data[e] : n.data[e] = o, d(e, t, o, true);
                  });
                }), s.connectMessage(kt({
                  messageId: io(),
                ...
                const p = (e, t) => c(n.data[e], t),
                  ...
                  M = e => {
                    const t = n.data[e];
                    n.ts = Nn(), delete n.data[e], g(e, true), d(e, t, n.data[e], false);
                  },
                  y = e => {
                    It(e) ? Qt(e, e => {
                      M(e);
              ...
              p = (() => {
                const e = i(u.grant, ko),
                  t = (() => {
                    ...
                    return kt({
                      register: (n, r) => {
                        zt(e, n), t || (Zo(o), t = co.connect("onurlchange", true), t.onMessage.addListener(t => {
                          if ("ack" in t) return;
                          const {
                            url: n
                          } = t;
                      ...
                      unregister: n => {
                        let o;
                        n && (o = Yt(e, n)) > -1 && (e = Xt(e, o, 1).result), t && 0 === e.length && (t.disconnect(), t = null);
                      }
                    });
                  })();
                return kt({
                ...
                const e = i(u.grant, Eo),
                  t = e => {
                    for (let t = 0; t < u.resources.length; t++) {
                      ...
                      if (n.name == e) {
                        if (n.error) to.warn("@resource: " + n.error);else try {
                  ...
                  n = e => {
                    for (let t = 0; t < u.resources.length; t++) {
                      const n = u.resources[t];
                      if (n.name == e) {
                        if (n.error) to.warn("@resource: " + n.error);else if ("string" == typeof n.content) {
                          try {
              ...
              m = (() => {
                  ...
                  r = e => {
                    ...
                    const d = (e, t) => {
                        ...
                        if ("Blob" === n || "File" === n) {
                          ...
                          const s = kt({}),
                            i = [];
                          for (; !(r = o.next()).done;) zt(i, r.value);
                          const a = () => {
                            if (i.length) {
                              const e = Bt(i);
                              let t = n.getAll(e);
                              "[]" !== bn(e, -2) && (t = Yn(t, 0)), d(t, t => {
                                s[e] = t, a();
                              });
                            } else t(kt({
                              type: "FormData",
                          ...
                          a();
                        } else if ("URLSearchParams" === n) t(kt({
                      ...
                      g = (e, t, n, o, r) => {
                        let s;
                        if (n) "stream" == o && (s = n);else if ("arraybuffer" == o) s = t || Uo(e || "");else if ("blob" == o) s = new no.Blob([t || Uo(e || "")], kt({
                          type: r
                        }));else if ("json" == o) s = Nt(e || "");else if ("document" == o) {
                          ...
                          let t = "";
                          const n = new Kn(e);
                          for (let e = 0; e < n.length; e += 32687) t += Pt(hn, null, n.subarray(e, e + 32687));
                          return t;
                        })(t) : "");
                        return s;
                      };
                    return (e => {
                      if (r.url) {
                        ...
                        if (-1 != Yt(["data:", "blob:"], t)) return e();
                      }
                      if (!r.data) return e();
                      d(r.data, t => {
                        r.binary && (t.type = "Blob"), r.data = t, r.data_type = "typified", e();
                      });
                    })(() => {
                      if (i) return i = false, void l(r.onabort);
                      let e,
                        s,
                        c,
                        d = co.connect("xhr"),
                      ...
                      if (T.headers) {
                        const e = T.headers;
                        Qt(bt(e), t => {
                          "cookie" === En(t) && (T.cookie = `${e[t]}`, delete e[t]);
                        });
                      }
                      let D, A, U, $;
                      d.postMessage(kt({
                      ...
                      const q = function () {
                          var t = n(function* (t) {
                            if (t && (c || undefined !== e || undefined !== s)) {
                              if (R ? $ = R : t && ($ = (e => {
                                const t = kt({});
                                return e && Qt(en(e, "\n"), e => {
                                  const n = en(e, ":");
                              ...
                              })(t.responseHeaders)["content-type"]), D = e, c) U = c.stream;else if (s) {
                                const e = s;
                                if (A = e.buffer, -1 == Yt(["blob", "arraybuffer"], j) && !D) {
                                  let t;
                                  qt([$, e.type], e => t = ((e, t, n, o) => {
                                    ...
                                    const s = bn(e, r + 8),
                                      i = Mn(s, ";");
                                    return -1 == i ? o && o.optionalEnd ? s : undefined : bn(e, r + 8, i);
                                  })(En(e || ""), 0, 0, kt({
                                    optionalEnd: true
                                  })));
                                  const n = new zn([A]);
                            ...
                            if (D || U || A) {
                              t.responseType = S, Qt(["response_data"], e => delete t[e]);
                              const e = kt({
                      ...
                      "stream" === j && B(n(function* () {
                        c = yield oo(e => {
                          const t = new no.ReadableStream(kt({
                            ...
                            cancel: () => {
                              c && (c.canceled || a(), c.canceled = true);
                            }
                          }));
                        });
                      }));
                        ...
                        var t = n(function* (t) {
                          if (!("ack" in t)) if (t.onpartial) {
                            ...
                            if (c) {
                              ...
                              if (undefined !== r) e(c.ctrl, r);else if (undefined !== i) {
                                const t = new Kn(i.buffer);
                                e(c.ctrl, t);
                              } else to.error(`${v}:`, "data message without data?!");
                            } else {
                              let t;
                              r && zt(p, r), i && (t = i), undefined !== o.index && o.index !== o.length - 1 || (p.length && (e = Kt(p, ""), p = []), s = t);
                            }
                          } else {
                            const e = t.data;
                            if (F = e.readyState || F, N = e.status || N, G && (e.context = G), t.onload) yield q(e), l(r.onreadystatechange, e), l(r.onload, e);else if (t.onreadystatechange) yield q(e), 4 != e.readyState && l(r.onreadystatechange, e);else if (t.onerror) t.exception && to.error(t.exception), l(r.onerror, e);else if (t.onabort) l(r.onabort, e);else if (t.ondone) f = true, c && !c.canceled && (_n || (e => e.close()))(c.ctrl), yield q(e), l(r.onloadend, e);else if (t.onloadstart) c && (yield q(e)), l(r.onloadstart, e);else if (t.onuploadprogress) r.upload && l(r.upload.onprogress, e);else {
                      ...
                      d.onMessage.addListener(e => B(() => H(e))), d.onDisconnect.addListener(() => {
                        f || l(r.onerror, kt({
                          readyState: F,
                          status: N,
                ...
                return Qt(bt(s), e => Tt(r, e, s[e])), kt({
              ...
              h = (() => {
                ...
                const n = (e, n) => {
                  ...
                  t && t.disconnect(), Zo(o);
                  let s = t = co.connect("webRequest", true);
                  return n && s.onMessage.addListener(e => {
                    "ack" in e || n(e.type, e.message || "ok", e.details);
                  }), s.onDisconnect.addListener(r), s.connectMessage(kt({
                    messageId: io(),
                    rules: e,
                    uuid: u.uuid
                  })), kt({
                ...
                const n = kt({}),
                  ...
                  r = (e, r, i) => {
                    ...
                    const {
                      ...
                      g = undefined !== d ? d : ++t,
                      p = n[g],
                      f = p || co.connect("registerMenuCommand", true);
                    return o[g] = r, p || (f.onMessage.addListener(e => {
                      if (!("ack" in e) && "run" === e.method) {
                        const t = o[g];
                        if (!t) return;
                        const n = e.event,
                          r = n ? n.keyCode ? new Hn("keypress", n) : new Wn("click", e.event) : undefined;
                        Wo(() => t(r), 1);
                      }
                    }), f.onDisconnect.addListener(() => {
                      s(g);
                    }), n[g] = f), f.connectMessage(kt({
                      messageId: io(),
                      name: e,
                      uuid: u.uuid,
                      accessKey: a,
                  ...
                  t = (e, t, n, o) => {
                    ...
                    if ("object" == typeof e) {
                      ...
                      s = a(m), r = kt({
                        ...
                        timeout: l,
                        text: c,
                        image: d || u.icon64 || u.icon || undefined,
                        title: g || u.name,
                        highlight: p,
                        silent: f,
                        url: v,
                        tag: m
                      }), i = n.ondone, o = n.onclick, "function" == typeof t && (i = t);
                    } else s = a(), r = kt({
                      id: s,
                      text: e,
                      title: "string" == typeof t ? t : u.name,
                      image: n || u.icon64 || u.icon || undefined
                    });
                    r.onclick = o, r.ondone = i || undefined, ((e, t) => {
                      const {
                        text: n,
                        title: o,
                        tag: r,
                      ...
                      if (n || a) {
                        ...
                        p.onMessage.addListener(e => {
                          ...
                          t && (d && d(f), p.postMessage(kt({
                            messageId: io(),
                            canceled: u
                          }))), g && g(true === t, f), p.disconnect();
                        }), p.connectMessage(kt({
                          messageId: io(),
                          method: "notification",
                          id: e,
                      ...
                      } else to.warn("GM_notification: neither a message text nor highlight options were given!");
                    })(s, r);
                  };
                return kt({
              ...
              w = (() => {
                const e = i(u.grant, wo),
                  ...
                  n = (e, n) => {
                    ...
                    let g;
                    Zo(o);
                    let p = co.connect("download", true);
                    const f = () => {
                      p && p.stopReconnecting();
                    };
                    p.onMessage.addListener(e => {
                      if (!("ack" in e)) {
                        p && undefined === g && (g = e.id, p.connectMessage(kt({
                          messageId: io(),
                          method: "download",
                          uuid: u.uuid,
                          id: g
                        ...
                        try {
                          e.load ? (r.onload && s(r.onload, e.data), f()) : e.progress ? r.onprogress && s(r.onprogress, e.data) : e.timeout ? (r.ontimeout && s(r.ontimeout, e.data), f()) : (r.onerror && s(r.onerror, e.data), f());
                        } catch (e) {
                ...
                const e = i(u.grant, Lo),
                  t = (e, t) => {
                    ...
                    const l = (() => {
                      ...
                      return kt({
                        run: t => {
                          if (t && zt(e, t), r) for (; e.length;) Bt(e)();
                        }
                      });
                    })();
                    Zo(o);
                    let c = co.connect(n, true);
                    const d = () => {
                      c && c.postMessage(kt({
                        messageId: io(),
                        close: true
                    ...
                    c.onMessage.addListener(e => {
                      "ack" in e || (e.tabId ? i ? d() : (c && undefined === r && c.connectMessage(kt({
                        messageId: io(),
                        method: n,
                        uuid: u.uuid,
                        tabId: e.tabId
                      }), false), r = e.tabId, l.run()) : e.name ? s = e.name : e.closed && (i = true, a && (a(), a = null), c && c.stopReconnecting()));
                    }), c.onDisconnect.addListener(() => c = null), c.postMessage(kt({
                      messageId: io(),
                      method: n,
                      url: e,
                      location: no.location.href,
              ...
              L = ({
                ...
                const a = Zn.getElementById(s),
                  l = n ? n.id : undefined;
                return undefined !== l && xn(a, "id", l), a;
              },
              I = (() => {
              ...
              O = (() => {
                const e = i(u.grant, bo),
                  t = (e, t, n, o) => {
                    let r, s, i, a;
                    return "string" == typeof e ? (s = e, i = t, a = n) : (r = e, s = t, i = n, a = o), i && (i = kt(i)), L(kt({
                      root: r,
                      tag: s,
                      properties: i,
                      cb: a
                ...
                const e = i(u.grant, ho),
                  t = (e, t) => {
                    const n = "backgroundControl",
                      r = co.connect(n);
                    let s = false;
                    const i = "restart" === e.action || undefined;
                    r.onMessage.addListener(e => {
                      if ("ack" in e) return;
                      s = true;
                      const n = e ? e.error : undefined;
                      n && to.warn(n), t && t(n), r.disconnect();
                    }), r.postMessage(kt({
                      messageId: io(),
                      method: n,
                      id: o,
                      uuid: u.uuid,
                      restart: i
                    })), i && (Qo = false), r.onDisconnect.addListener(() => {
                      !s && t && t(i ? undefined : "port disconnected for unknown reason"), s = true;
                    });
                  };
                return kt({
            ...
            return s[e.script.uuid] = s[e.script.uuid] || x, s[e.script.uuid];
          }
        });
      },
      tr = (e, t, o, r, s, i) => {
        const a = (e, t, n, o, r) => {
          ...
          l = function () {
            var e = n(function* (e, t, n, o) {
              ...
              yield null, n || (yield null), "load" === e && (yield null), ((e, t, n, o) => {
                const r = kt({
                    bubbles: true,
                    cancelBubble: false,
                    cancelable: false,
        ...
        const u = kt({}),
          ...
          g = (e, r, s) => {
            ...
            const f = d(s);
            let m, _;
            if (undefined !== i && c && ((m = "DOMContentLoaded" == e) || "load" == e)) {
              const n = On(vt.document);
              if (m && ("complete" == n || "interactive" === n) && "document-idle" != t || !m && "complete" == n) return void l(e, i, f, v);
            }
            const h = "urlchange" == e ? o["window.onurlchange"] : undefined;
            if (undefined === i) ;else if ("string" != typeof i) {
              const t = `${e}-${f}`;
              u[t] = u[t] || [];
              const n = function (...t) {
                  return "object" == typeof s && s.once && p(e, r, s), Pt(i, this === vt || this === mt ? v : this, t);
                },
                o = kt({
                  listener: i,
                  filter: n,
              ...
              if (zt(u[t], o), _ = n, h) return void h.value.register(n);
            } else {
              if (h) return void to.warn("env: urlchange listener must be a function!");
              _ = i;
            }
            return a(no.addEventListener, [e, _, s], 1, true);
          },
          p = (e, t, n) => {
            let r, s;
            null === t || ("object" == typeof t ? s = t : r = t);
            const i = "urlchange" == e ? o["window.onurlchange"] : undefined,
              l = d(n),
              c = `${e}-${l}`,
            ...
            if (g && g.length) {
              let t;
              if (Qt(g, o => {
                if (i) i.value.unregister(o.filter);else try {
                  a(no.removeEventListener, [e, o.filter, n], 1, true);
                } catch (o) {
                  t = o;
                }
                const r = Yt(u[c], o);
                u[c] = Xt(u[c], r, 1).result;
              }), u[c].length || delete u[c], t) throw t;
            } else if (undefined !== r) return a(no.removeEventListener, [e, r, n], 1, true);
          },
          f = kt({
            CDATA: kt({
              value: function (e) {
            ...
            setTimeout: kt({
              value: (...e) => a(zo, e, 0, true, v)
            }),
            setInterval: kt({
              value: (...e) => a(Yo, e, 0, true, v)
            }),
            close: (() => {
            ...
            onurlchange: o["window.onurlchange"] ? (() => {
              ...
              return kt({
                get: () => e,
                set: t => {
                  e && p("urlchange", e), e = t, g("urlchange", e);
                }
              });
            })() : undefined,
            location: kt({
    ...
    n(function* () {
      ...
      r.setMessageListener(({
        ...
        if ("commid" == t) r.switchId(n.id), r.send("ack", kt({
          id: n.id
        }));else if ("injectable" == t) p(n.id, () => {
          r.send("ack", kt({
            id: n.id
          }));
        }), r.send("injectableack", kt({
          id: n.id
        }));else if ("setForeignAttr" == t) vt[n.attr] = n.value;else if ("script" == t) {
          const {
              id: t,
              unwrap: o,
              bundle: s
          ...
          p(t, t => {
            const r = o ? () => t() : () => Pt(t, ((t, n, o, r) => {
              ...
              u && (Tt(f, "GM", kt({
                ...
                value: _
              }))), d || (m.unsafeWindow = _), Qt(bt(g), e => {
                const t = bn(e, 0, 3),
                  n = g[e];
                if (undefined !== n) if ("GM_" === t) m[e] = undefined !== n.get ? n.get() : n.value, u && Tt(f, e, n);else if ("GM." === t) {
                  const t = tn(e, 3);
                  n.configurable = n.enumerable = true, "value" in n ? n.writable = true : "set" in n || (n.set = e => {
                    delete v[t], v[t] = e;
                  }), Et(v, t, n);
                }
              });
        ...
        } else if ("port.message" == t) co.message(n, r);else if ("external.connect" == t) (t => {
          const {
              bridges: n
            } = e,
            o = vt,
          ...
          try {
            const e = () => {
              const e = kt({
                ...
                isInstalled: (e, t, n) => {
                  "function" == typeof t && (n = t, t = null), n && i(kt({
                    method: "isInstalled",
                    script: kt({
                      name: e,
                      namespace: t
          ...
          const {
            ...
            t = Dt(u, e);
          t ? "function" == typeof t && (t(), delete u[e]) : c.warn(`env: missing script "${e}"!`);
        }
      });
      const {
          createProxy: d
          ...
          const n = (e => {
            ...
            const n = (e, o, r) => {
              const s = Rt(e);
              s && s === o || (null != s && --r >= 0 && n(s, e, r), t = yt(t, Lt(e)));
            };
            return n(e, null, 5), t;
          })(vt);
          Qt(o, e => delete n[e]);
              ...
              const f = new qn(p, kt({
                defineProperty: (e, t, o) => {
                  const {
                    ...
                    d = kt(o);
                  return r && !r.configurable && (!!r.configurable != !!d.configurable || !!r.enumerable != !!r.enumerable) || i(t) ? (Et(u ? p : vt, t, d), false) : (Et(p, t, d), l(t) && a(t) && c(t), delete n[t], true);
                },
                deleteProperty: (e, t) => {
                  let {
                    d: i,
                  ...
                  return !(!i || !i.configurable) && (u && (u = delete p[t], l(t) && a(t) && c(t)), (d || (i = o[t]) && i.configurable) && (r === o && (o = yt(kt({}), r)), d = delete o[t]), delete n[t], u || d);
                },
                get: (e, t) => {
                  if ("undefined" === t || t === Rn) return;
                  const o = n[t];
                  if (o) {
                  ...
                  if (r) {
                    let e;
                    const n = "value" in r ? Dt(r, "value") : (e = Dt(r, "get")) && "function" == typeof e ? a ? e() : Vt(e, vt)() : undefined;
                ...
                ownKeys: () => {
                  const e = e => !(e in o),
                    ...
                    n = Ht(bt(Lt(p)), e),
                    r = kt({});
                  for (let e = 0; "Window" === sn(At(vt, e)); e += 1) r[e] = true;
                  const s = Ht(bt(r), e);
                  return Jt(t, n, s);
                },
                ...
                set: (e, t, o) => {
                  ...
                  return !(u && !u.writable && !Dt(u, "set") || i(t) || (delete n[t], Tt(p, t, o), l(t) && a(t) && c(t, o), 0));
                }
              }));
              return f;
            }
        ...
        v = (e, t) => t ? ((e, t) => {
          const n = `__p__${io()}`;
          f(n, t, undefined), g('window["' + n + '"] = function(){' + e + "};"), delete mt[n];
        })(e, t) : g(e);
    })(), lo();
  })();
})({
